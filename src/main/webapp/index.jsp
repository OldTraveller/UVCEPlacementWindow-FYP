		 ...
		 <div class="row align-items-center">
		      <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
		        <h2 class="text-center bolder w3-animate-bottom">Concepts and Technology used from Engineering at UVCE</h2>
					<ul class="list-group">
					  <li class="list-group-item">Digital Signature (Network Security 6th Semester)</li>
					  <li class="list-group-item">Authentication and Authorization (Network Security)</li>
					  <li class="list-group-item">Java Programming language (JAVA Labs 3rd Semester)</li>
					  <li class="list-group-item">Spam Detector at BackEnd (Data Mining - Naive Bayesian Classifier)</li>
					</ul>
				</p>
		      </div>
		      <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
		        <img alt="We Are All Together !!" class="img-fluid black-border" src="images/CSE.jpg" >
		      </div>
		    </div>
		  </div>
		</section>
